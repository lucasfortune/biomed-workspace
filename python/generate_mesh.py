...
def export_threejs_json(meshes, output_path, mesh_id):
    ...
    export_data = {
        "metadata": {
            "version": "1.0",
            "type": "BufferGeometry",
            "generator": "BioMed Workspace mesh generator",
            "mesh_id": mesh_id,
...
def export_obj(meshes, output_path):
    ...
    # Write OBJ file
    with open(output_path, 'w') as f:
        f.write("# OBJ file generated by BioMed Workspace mesh generator\n")
...
def export_stl(meshes, output_path):
    ...
    with open(output_path, 'wb') as f:
        # Header (80 bytes)
        header = b'Binary STL generated by BioMed Workspace mesh generator'
