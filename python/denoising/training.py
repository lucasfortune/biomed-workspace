    ...
    try:
        ...
        if run_stage2:
            ...
            extractor = StructuralNoiseExtractor(
                ...
                adapt_DF=extractor_config.get('adapt_DF', 0.65),
                center_size=extractor_config.get('center_size', 15),
                base_percentile=extractor_config.get('base_percentile', 50),
                percentile_decay=extractor_config.get('percentile_decay', 1.035),
                center_ratio_threshold=extractor_config.get('center_ratio_threshold', 0.2),
