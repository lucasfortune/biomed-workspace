...
def extract_mask(config: dict):
    ...
    try:
        ...
        extractor = StructuralNoiseExtractor(
            ...
            adapt_DF=extractor_params.get('adapt_DF', 0.65),
            center_size=extractor_params.get('center_size', 15),
            base_percentile=extractor_params.get('base_percentile', 50),
            percentile_decay=extractor_params.get('percentile_decay', 1.035),
            center_ratio_threshold=extractor_params.get('center_ratio_threshold', 0.2),
